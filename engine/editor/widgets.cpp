...
void NG_Node::PushWindowWorkRect(const NG_Canvas& canvas)
{
    ...
    m_ParentContentRegionMax = window->ContentRegionRect.Max;
    ...
    window->ContentRegionRect.Max = window->WorkRect.Max;
...
{
    // Reset window region states.
    ImGuiWindow* window = ImGui::GetCurrentWindow();
    ImGui::PopItemWidth();
    window->ContentRegionRect.Max = m_ParentContentRegionMax;
